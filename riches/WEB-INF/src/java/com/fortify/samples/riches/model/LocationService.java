...
public class LocationService {
    ...
    /*
     * Example on how prepareStatement can be misused in such a way that the query
     * is still vuln to SQLi
     */
    public static List findByZip(String zip) throws Exception {
        ...
        try {
            ...
            statement.setString(1, zip); // 20250519 - JC fix
            ResultSet rs = statement.executeQuery();
            while (rs.next()) {
                locations.add(new Location(rs.getString("address"), rs.getString("city"), rs.getString("state"),
    ...
    public static List findAtmByAddress(String address, String city, String state) throws Exception {
        ...
        try {
            ...
            String queryStr = "SELECT * FROM location WHERE branch = 'Yes' AND state = '" + state + "' AND city = '"
                    + city + "' AND address = '" + address + "'";
